...
import static com.example.snakeandladder.App.mediaPlayer;
...
//            coin.setTranslateY(gameBoard.getYCoord(position));
            ...
            if(newPos!=position && newPos>position)
            {
                ...
                mediaPlayer.stop();
                App.playHitsound("D:\\Acciojob\\IntelliJ\\demo\\src\\main\\resources\\com\\example\\demo\\climb.mp3");
                mediaPlayer.play();
            }
            if(newPos!=position&& newPos<position)
            {
                ...
                secondMove=translatePlayer();
                mediaPlayer.stop();
                App.playHitsound("D:\\Acciojob\\IntelliJ\\demo\\src\\main\\resources\\com\\example\\demo\\negative.mp3");
                mediaPlayer.play();
            }
            if(secondMove==null)
            {
