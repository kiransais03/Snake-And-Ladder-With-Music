    ...
    //Arraylist pair (positionCoordinates ArrayList.
    {
        ...
        for(int i=0;i<App.height;i++)
        {
            for(int j=0;j<App.width;j++)
            {
                ...
                if(i%2==0)
                {
                    Xcord = j*App.tileSize+App.tileSize/2;
                }
                else
                {
                    Xcord=App.tileSize*App.height-j*App.tileSize-App.tileSize/2;
                }
                int Ycord = App.tileSize*App.height-i*App.tileSize-App.tileSize/2;
